  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.comments}>
           { isLoading ? "loading": data?.map((item)=>( <div className={styles.comment} key={item._id}>
                <div className={styles.user}>
                    {item?.user?.image && <Image alt='' src={item.user.image} width={50} height={50} className={styles.image}/>}
